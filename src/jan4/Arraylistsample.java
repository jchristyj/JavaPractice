...
public class Arraylistsample {
	...
	public static void main(String[] args) {
		...
		/*public static void streamMap()
		{
			...
			boolean value=concatname.anyMatch(s->s.equalsIgnoreCase("Jo"));
		...
		public static void streamCollect()
		{
			...
			List<String> ls=Stream.of("Ajay", "Abi", "Vinay").filter(s->s.endsWith("y")).map(s->s.toUpperCase()).collect(Collectors.toList());			
		    System.out.println(ls.get(0));
		    //unique numbers to printed in an array
		    List<Integer> num = Arrays.asList(2,3,4,1,2,1,2,5,6);
		    //unique value
